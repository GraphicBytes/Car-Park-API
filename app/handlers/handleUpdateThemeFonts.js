...
export async function handleUpdateThemeFonts(app, req, res) {
  ...
  try {
    ...
    let update = {
      $set: {
        'data.theme_data.theme_fonts': newData,
      }
    };
...
export default handleUpdateThemeFonts;